        ...
        common.update(
            {
                ...
                "holeShape": record.hole_shape.to_int() if record.hole_shape is not None else None,
                "holeSlotLength": coordinate(record.hole_slot_length),
                "holeRotation": record.hole_rotation,
